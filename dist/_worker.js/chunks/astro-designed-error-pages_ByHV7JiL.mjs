...
import { a7 as REDIRECT_STATUS_CODES, A as AstroError, a8 as ActionsReturnedInvalidDataError, a9 as escape, D as DEFAULT_404_COMPONENT } from './astro/server_DPP3diHq.mjs';
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { OS: process.env.OS, set: process.env.set })?.DEV) {
...
function deserializeActionResult(res) {
  if (res.type === "error") {
    ...
    if (Object.assign(__vite_import_meta_env__, { OS: process.env.OS, set: process.env.set })?.PROD) {
